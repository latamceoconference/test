    ...
    <div className="mx-auto max-w-md">
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-black/60">Acesse sua conta para salvar endereço e recomprar mais rápido.</p>
        </CardHeader>
        <CardContent className="grid gap-3 pt-0">
          ...
          <div className="flex items-center justify-between text-sm text-black/60">
            <Link href={`/signup?returnTo=${encodeURIComponent(returnTo)}`} className="hover:text-black">
              Criar conta
            </Link>
